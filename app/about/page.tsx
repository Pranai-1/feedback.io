          ...
          <div className="max-w-3xl mx-auto xl:max-w-4xl">
            ...
            <div className="mt-10">
              <p className="text-base font-normal leading-7 text-gray-300">
                Welcome to Feedback.io, your go-to solution for effortless and
                efficient testimonial collection. In today&apos;s fast-paced digital
                world, understanding user experience and gathering actionable
                insights is crucial for success.Feedback.io is here to simplify
                that process, offering a powerful platform to collect, manage,embed through widgets
                and analyze testimonials directly from your website.
              </p>
              {/* <Image
              ...
              <p className="mt-6 text-base font-normal leading-7 text-gray-300">
                AtFeeback.io, we are dedicated to helping businesses and
                developers harness the power of user testimonials. Our mission is to
                provide a space that not only simplifies the feedback collection
              ...
              <p className="mt-6 text-base font-normal leading-7 text-gray-300">
                ...
                about how Feeback.io works, need help integrating it into your
