...
console.log(spaceInputs)
    return(
        ...
        <p className="bg-[#A7F3D0] rounded-full w-max text-[#059669] text-sm sm:text-base font-medium py-1 px-2 sm:px-4 absolute -top-3 left-8 md:left-8  sm:left-[320px] lg:left-8">{displayPage==1 ? 'Live preview - Thank you page':'Live preview - Testimonial page'}</p>
