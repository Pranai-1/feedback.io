...
console.log(scrollY)
    return(
       <div className="flex flex-col justify-center items-center absolute top-0 right-0 left-0 z-10">
        <Image src={projectOfTheWeek.src} width={200} height={200} alt="Project" className={`mt-6 ${scrollY > 40 ? 'blur-sm' :''}`}/>
        <div className="lg:text-6xl md:w-[70vw] text-2xl text-center md:text-5xl w-[80vw] shrink-0 text-white mb-8 blur-md">
        ...
        <p className="text-[#D5D5D5] md:w-[50vw] w-[80vw] text-sm md:text-base text-center mb-8">Easily embed testimonial widgets on your website and showcase authentic feedback,
             ...
             <button className="flex  font-medium gap-2 justify-center items-center text-black p-2 px-4 bg-[#E1E1E1] rounded-md" >Get Started for free 
                ...
                <AvatarCircles className="mt-6 mb-2" avatarUrls={[
                    ...
                    <p className="w-[25vw] mt-2 font-medium text-[#92A0B5]">More than 12 trusted partners using <span className="text-gray-50">Feedback.io</span></p>
       </div>
    )
}