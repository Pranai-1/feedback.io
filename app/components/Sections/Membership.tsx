        ...
        <div className="flex flex-col justify-center items-center mt-10 gap-4">
           ...
           <div className="flex flex-wrap justify-center items-center gap-10 text-gray-100 mt-4">
              {pricingPackages.map((pricing)=>(
                <div className="flex flex-col justify-start items-start  border border-gray-400 rounded-lg p-4 gap-2 w-[40%]">
                    ...
                    <p className="flex justify-center items-center text-3xl font-bold my-3 ">₹{pricing.price}
                        ...
                        <div className="flex flex-col justify-center items-start gap-2">
                           {pricing.features.map((feature)=>(
                            <p className="flex justify-center items-center gap-4 text-gray-300"><TiTick/>{feature}</p>
                           ))}
                        </div>
                </div>
              ))}
