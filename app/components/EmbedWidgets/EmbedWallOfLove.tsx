...
export default function EmbedBadge(){
    ...
    return(
        ...
        <div className="bg-[#FFFFFF] rounded-md h-max w-[90%]  flex flex-col justify-center items-center gap-4 pb-4 ">
          ...
          <div className={`xl:w-[45%] w-[100%]  h-[440px] cursor-pointer flex flex-col justify-center items-center gap-24 p-2 border-2 border-gray-600
         ...
         <Image src={manualImage.src} alt="Manual Image" height={300} width={600}/>
           <p className="text-orange-600 font-medium text-lg text-center ">Manual Carousel</p>
            ...
            <div className={`lg:w-[400px] md:w-[340px] w-full h-[440px] overflow-hidden cursor-pointer flex flex-col justify-center items-center gap-4 p-2 border-2 border-gray-600
