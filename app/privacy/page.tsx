          ...
          <div className="max-w-3xl mx-auto xl:max-w-4xl">
            ...
            <div className="mt-10">
              <p className="text-base font-normal leading-7 text-gray-300">
                At Feedback.io, we prioritize the privacy and security of our
              ...
              <p className="mt-6 text-base font-normal leading-7 text-gray-300">
                When users fill the feedback form, we may collect various types
                of information:
              </p>
              ...
              <p className="mt-6 text-base font-normal leading-7 text-gray-300">
                ...
                please contact us at reddypranai2017@gmail.com.
              </p>
